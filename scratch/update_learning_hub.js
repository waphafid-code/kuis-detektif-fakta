...
const learningHubPath = path.join(__dirname, '..', 'js', 'learning_hub.js');
let content = fs.readFileSync(learningHubPath, 'utf8');

// Build the new LEARNING_MODULES object with 8 slides each
const newLearningModulesCode = `// 📚 DATASET MATERI PEMBELAJARAN INTERAKTIF (KOMPREHENSIF, BERBOBOT & MENYENANGKAN)
                ...
                contentHtml: \`
                    <div class="learn-diagram-box">
                        ...
                        <p style="margin: 0; font-size: 0.85rem; line-height: 1.55; color: var(--text);">
                            ...
                            <br><strong>Contoh Nyata:</strong> Struktur folder di komputer (<code>C:\Tugas\Informatika\Modul.pdf</code>) dan susunan elemen HTML (DOM Tree).
                        </p>
                    </div>
...
// Replace from 'const LEARNING_MODULES = {' to 'window.LEARNING_MODULES = LEARNING_MODULES;'
const startMarker = 'const LEARNING_MODULES = {';
const endMarker = 'window.LEARNING_MODULES = LEARNING_MODULES;';
...
const newContent = content.substring(0, startIndex) + newLearningModulesCode + '\n\n' + content.substring(endIndex);
fs.writeFileSync(learningHubPath, newContent, 'utf8');
console.log('Successfully updated js/learning_hub.js with expanded 8-slide modules!');
